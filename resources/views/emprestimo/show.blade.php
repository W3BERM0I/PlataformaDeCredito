...
<main>
  <aside id="right">
    ...
    <form action="{{route('emprestimo.cancela', $emprestimo->id)}}" method="post">
      @csrf
      @method('PUT')
      <button class="btn btn-danger">Cancelar solicitaçao</button>
    </form>
    @endif
  </aside>
  <aside id="left">
      ...
      <table class="table table-bordered table-striped table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{ route('emprestimo.show', $emprestimo->id) }}" class="btn btn-secondary bo" value="{{$emprestimo->id}}">Pagar</a>
            </td>
          </tr>
          @endforeach
          </form>
