<template>
   <div class="principal">
    ...
    <div class="card" v-show="isGestor || isDiretor">
      <div class="card-body">
        <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" class="bi bi-fire mx-auto d-block" viewBox="0 0 16 16">
    ...
    <div class="card" v-show="isDiretor">
      <div class="card-body center">
        <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" class="bi bi-bar-chart-line mx-auto d-block" viewBox="0 0 16 16">
...
export default {
  computed: {
    isGestor() {
      return Boolean(this.$store.state.usuario.tipo_usuario == "GESTOR")
    },
    isDiretor() {
      return Boolean(this.$store.state.usuario.tipo_usuario == "DIRETOR")
    }
  }
}
</script>
